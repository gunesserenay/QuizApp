package com.moonsunapp.quizapp
...
class QuizQuestionsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private var imgCountryImage: ImageView? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imgCountryImage = findViewById(R.id.imv_countryImage)
...
//        }
        ...
        imgCountryImage?.setImageResource(question.image)
    ...
    private fun selectedOptionView(tvSelected: TextView, selectedOptionNum: Int) {

        defaultOptionsView()

        mSelectedOptionPosition = selectedOptionNum

        tvSelected.setTextColor(Color.parseColor("#363a43"))
        tvSelected.setTypeface(tvSelected.typeface, Typeface.BOLD)
        tvSelected.background =
